...
class UpdateService(private val context: Context) {
    ...
    fun getDemoUpdateInfo(): UpdateInfo {
        ...
        return UpdateInfo(
            ...
            latestVersionCode = 2,
            releaseTitle = "CleanCache Pro v1.1.0 - Performa Pembersih Lebih Cepat",
            ...
            apkDownloadUrl = "https://github.com/$githubOwner/$githubRepo/releases/download/v1.1.0/CleanCachePro-v1.1.0.apk",
            apkFileName = "CleanCachePro-v1.1.0.apk",
    ...
    suspend fun downloadApk(
        ...
        try {
            ...
            if (downloadUrl.contains("example.com") || downloadUrl.contains("releases/download/v1.1.0")) {
